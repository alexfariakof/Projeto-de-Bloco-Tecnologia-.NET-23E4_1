...
$sourceDirs = "$projectPath\PixCharge.Domain;$projectPath\PixCharge.Infrastructure;$projectPath\PixCharge.Repository;$projectPath\PixCharge.SPA;$projectPath\PixCharge.Repository;$projectPath\PixCharge.SPA\angularapp"
...
$filefilters = "-$projectPath\PixCharge.Infrastructure.Migrations_MsSqlServer\**;-$projectPath\PixCharge.Infrastructure.Migrations_MySqlServer\**;-$projectPath\PixCharge.Adapter\**;"
